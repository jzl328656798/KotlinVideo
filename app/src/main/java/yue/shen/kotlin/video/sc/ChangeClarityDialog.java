...
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        windowParams.width = ScUtil.INSTANCE.getScreenHeight(context);
        windowParams.height = ScUtil.INSTANCE.getScreenWidth(context);
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : ScUtil.INSTANCE.dp2px(getContext(), 16f);
